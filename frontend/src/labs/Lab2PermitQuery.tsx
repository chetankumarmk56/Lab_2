...
import { ArrowRight, ArrowUp, Check, Copy, Database, Download, Lock, Trash } from '../components/icons'
...
export default function Lab2PermitQuery() {
  ...
  function onInputKeyDown(e: KeyboardEvent<HTMLTextAreaElement>) {
    ...
    // Empty box + ↑ recalls the last question, terminal-style, ready to tweak.
    ...
    <div className="l2-root">
      ...
      >
        <div className="l2-composer-inner">
          <div className={`l2-composer-box ${loading ? 'is-busy' : ''}`}>
            ...
            />
            <div className="l2-composer-bar">
              <span className="l2-ro" title="The agent can only read — writes are declined.">
                <Lock width={11} height={11} /> Read-only
              </span>
              <div className="l2-composer-right">
                <span className="l2-kbd" aria-hidden="true">
                  <kbd>Enter</kbd> send<span className="l2-kbd-sep">·</span>
                ...
                >
                  {loading ? <span className="spinner" /> : <ArrowUp width={17} height={17} />}
                </button>
              </div>
            </div>
          </div>
